...
const AvailablePlayersList: React.FC<AvailablePlayersListProps> = ({ players, buildings }) => {
              ...
              <Accordion.Body>
                ...
                <Row>
                  ...
                  <Col md={3}>
                      ...
                      onChange={e => {
                        ...
                        if (value && value !== 'all') {
                          table.setColumnFilters(prev => [
                            ...prev.filter(f => f.id !== 'troopTypeFilter'),
                            { id: 'troopTypeFilter', value }
                          ]);
                        } else {
                          table.setColumnFilters(prev => 
                            prev.filter(f => f.id !== 'troopTypeFilter')
                    ...
                    >
                      <option value="all">All Troop Types</option>
                  ...
                  <Col md={3}>
                    <Form.Select
                      ...
                      onChange={e => {
                        ...
                        if (value && value !== 'all') {
                          table.setColumnFilters(prev => [
                            ...prev.filter(f => f.id !== 'shiftFilter'),
                            { id: 'shiftFilter', value }
                          ]);
                        } else {
                          table.setColumnFilters(prev => 
                            prev.filter(f => f.id !== 'shiftFilter')
